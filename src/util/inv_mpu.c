...
static int get_st_6500_biases(long *gyro, long *accel, unsigned char hw_test, int debug)
{
    ...
    gyro[0] = (long)(((int64_t)gyro[0]<<16) / test.gyro_sens / s);
    gyro[1] = (long)(((int64_t)gyro[1]<<16) / test.gyro_sens / s);
    gyro[2] = (long)(((int64_t)gyro[2]<<16) / test.gyro_sens / s);
    accel[0] = (long)(((int64_t)accel[0]<<16) / test.accel_sens / s);
    accel[1] = (long)(((int64_t)accel[1]<<16) / test.accel_sens / s);
    accel[2] = (long)(((int64_t)accel[2]<<16) / test.accel_sens / s);
