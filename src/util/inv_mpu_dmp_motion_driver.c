...
#define GYRO_SF             ((int64_t)46850825 * 200 / DMP_SAMPLE_RATE)
...
#else
    gyro_bias_body[0] = (long)(((int64_t)gyro_bias_body[0] * GYRO_SF) >> 30);
    gyro_bias_body[1] = (long)(((int64_t)gyro_bias_body[1] * GYRO_SF) >> 30);
    gyro_bias_body[2] = (long)(((int64_t)gyro_bias_body[2] * GYRO_SF) >> 30);
#endif
...
#else
    accel_bias_body[0] = (long)(((int64_t)accel_bias_body[0] * accel_sf) >> 30);
    accel_bias_body[1] = (long)(((int64_t)accel_bias_body[1] * accel_sf) >> 30);
    accel_bias_body[2] = (long)(((int64_t)accel_bias_body[2] * accel_sf) >> 30);
#endif
